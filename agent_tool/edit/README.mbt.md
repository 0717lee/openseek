...
Generated MoonBit interface files (`pkg.generated.mbti`) are rejected outright;
edit the source package and rerun `moon info` instead.
...
- `"error editing <path>: moon.pkg content is suspiciously small"` or similar
  ...
  discovery.
- `"error editing <path>: pkg.generated.mbti is generated by moon info; edit MoonBit source files instead"` — generated interface files must be refreshed through `moon info`.
