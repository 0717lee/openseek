...
Prefer `write` when the file is new or easier to reason about as a complete
replacement.
...
Generated MoonBit interface files (`pkg.generated.mbti`) are also rejected;
edit source files and rerun `moon info` instead.
...
- `"error writing <path>: pkg.generated.mbti is generated by moon info; edit MoonBit source files instead"` — generated interface files must be refreshed through `moon info`.
