...
This directory contains active plans and planning rules.
...
2. Delete the completed plan and any Gate companions from the current tree;
   Git retains the detailed artifacts.

Delete superseded or abandoned incomplete plans. Do not leave a stale proposed
plan that no longer matches the current package graph.
